...
class TestViews(TestCase):
    def test_get_home_page(self):
        ...
        self.assertEqual(page.status_code, 200) # Test URL 
        self.assertTemplateUsed(page, "todo_list.html") # Test Template

    def test_get_add_item_page(self):
        page = self.client.get("/add") 
        self.assertEqual(page.status_code, 200) # Test URL 
        self.assertTemplateUsed(page, "item_form.html") # Test Template
    ...
    def test_toggle_status(self):
        ...
        item.save()
        id = item.id
        response = self.client.post("/toggle_status/{0}".format(id))
        item = get_object_or_404(Item, pk=id)
